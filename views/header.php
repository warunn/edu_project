...
<div id="wrapper">
  <div id="main_banner"> <a href="<?php echo URL; ?>index"><img src="<?php echo URL; ?>views/index/img/new_side.jpg" name="new_side" id="new_side" /></a><img id="new_up" src="<?php echo URL; ?>views/index/img/new_up.jpg" />
    ...
    <a href="<?php echo URL;?>spage/pccs"><div class="upper_button">  Pccs </div></a>
    <div class="spacer">|</div>
<a href="<?php echo URL;?>spage/sports"><div class="upper_button">  Sports </div></a>
    <div class="spacer">|</div>
    <div class="upper_button">  Societies </div>
    <div class="spacer">|</div>
    <a href="pastpupils/pastlogin.php"><div class="upper_button">  Past Pupils </div></a>
...
//slider_select_next();
  ...
  <div id="side_bar">
    ...
    <a href="<?php echo URL;?>spage/principal"><div class="side_button"> Principal's Message</div></a>

   <div class="side_button"> School Administration </div>
    <div class="side_button"> Results </div>
    <a href="<?php echo URL;?>spage/wallpapers"><div class="side_button"> WallPapers</div></a>
    <a href="<?php echo URL;?>spage/oldphotos"><div class="side_button"> Old Photos</div></a>
    <a href="<?php echo URL;?>spage/contact"><div class="side_button"> Contact Us </div> </a>
    <?php
    $logged = Session::get('loggedin');
    if ($logged==true): ?>
    <a href="<?php echo URL?>dashboard/<?php echo Session::get('role');?>"><div class="side_button">Main <?php echo Session::get('role');?> Control Panel</div></a>
    <?php endif; ?>
    <?php
    $logged = Session::get('loggedin');
    if ($logged==false): ?>
    ...
    <?php else: ?>
    <a href="<?php echo URL;?>login/logout"><div class="side_button"> Logout</div></a>
    <?php endif; ?>
